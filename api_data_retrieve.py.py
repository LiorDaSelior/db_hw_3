...
def fill_movie_table(connection, cursor, movie_df):
    table_name = "movie"
    try:
...
def fill_person_table(connection, cursor, person_df):
    table_name = "person"
    try:
...
def fill_genre_table(connection, cursor, genre_df):
    table_name = "genre"
    try:
...
def fill_role_table(connection, cursor, role_df):
    table_name = "role"
    try:
...
def fill_movie_genre_table(connection, cursor, movie_genre_df):
...
def fill_movie_role_table(connection, cursor, movie_role_df):
